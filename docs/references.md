...
- **von Strachwitz, Alaa El-Din, Dutra, Vinko. "Data-efficient learning of exchange-correlation
  ...
  **This makes the planned LDOS loss EVIDENCED by close analogy rather than our own idea**, and
  independently motivates the `b` weighting.
...
- **Bishop. "Regularization and Complexity Control in Feed-forward Networks." *ICANN* (1995).**
  ...
  supports fixing rather than routing around.
...
NOT a factor in this decision: MATLAB's native `h5read` support. It is true, but the
group's MATLAB code is legacy and the field has moved to Python (2026-07-26), so
...
Both verified against the Crossref REST API -- authors, title, journal,
...
- **[SPOT-CHECKED]** Artes, J. M., Li, Y., Qi, J., Anantram, M. P., Hihath, J.
  ...
  SEQUENCE. Search engines misattribute it to
...
3. **That conductance is a function of sequence alone.** Artes 2015
...
- Qi, J., Govind, N., Anantram, M. P. "The role of cytosine methylation on charge transport
  ...
  DFT plus Landauer-Buttiker on an 8 bp strand, with TB onsite
...
> **REVISED 2026-08-11 after pushback, having checked the actual systems.** The
...
> matter, and they are not ours. Revised below. Both objections hold: the
...
functions. [DOMAIN, 2026-08-11: this coarse-graining is the innovation.]
...
1. **COARSE-GRAINING BELOW ATOMIC RESOLUTION.** [DOMAIN] Every precedent
...
2. **FINITE, SEQUENCE-DEFINED MOLECULES.** [DOMAIN] The learned-Hamiltonian
